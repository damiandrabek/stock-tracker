    ...
    <ScrollView contentContainerStyle={themedStyles.contentContainer}>
      ...
      <View>
        <Link href="/StockScreen" style={themedStyles.heading}>
          <ThemedText style={themedStyles.heading}>Your Watchlist 🔍</ThemedText>
        </Link>
        ...
        <Pressable style={themedStyles.searchButton}>
      ...
      <View>
        ...
        <ThemedText style={themedStyles.newsText}>
          UnitedHealth stock is crushing down the Dow. Here's the math behind the slide.
        </ThemedText>
        <ThemedText style={themedStyles.newsText}>
          Apple CEO spoke with Lutnick about tariff impact on iPhone prices, WP says.
        </ThemedText>
      </View>
    </ScrollView>
  );
